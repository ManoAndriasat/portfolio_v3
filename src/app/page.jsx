...
export default function Home() {
  ...
  useGSAP(() => {
    ...
    document.querySelectorAll(".work-details").forEach((work, index) => {
      ...
      ScrollTrigger.create({
        trigger: work,
        start: `top-=${contentHeight * index} 40%`,
        end: `bottom-=${contentHeight * (index + 1)} 40%`,
        onToggle: (self) => {
          if (self.isActive) {
    ...
    return (
      <>
        <div ref={secondHeaderRef} className="second-header flex justify-center fixed bottom-0 left-0 right-0 z-50 mb-4 opacity-0 none lg:flex">
        ...
        <div id='main' ref={mainRef} className="main min-h-[100vh] bg-[#f9f9f9]">
          <div className="about">
            ...
            <div className="about-details px-[5%] text-[#1c1b19]">
              ...
              <h2 ref={textRef} className='about-reveal text-[2.1em] lg:text-[4em] leading-none'>
                ...
                and design. I also like solving problems on LeetCode to improve my skills in algorithms and logic. Below are some of the projects I&apos;ve worked on.</h2>
            </div>
