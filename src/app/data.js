const Cards = [
    {
      ...
      details : "Development of a garage management system, including vehicle registration, asking appointments, following up on repairs, and managing customer information.",
    ...
    {
      name : "CRUD Generator",
      details : "Generates a CRUD API (Spring Boot) with a Vue.js web interface based on a database. Automatically includes authentication, registration, navigation, CRUD operations, PDF import, pagination, and UI design.",
      participants: "Group of 2 (50% contribution)",
      techno: "Java - Vue.js",
      society: "School",
